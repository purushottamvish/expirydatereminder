...
public class ItemDetailsOnClick extends AppCompatActivity implements View.OnClickListener {

    TextView itemName, expiresOn, categoryName;
    Button  deletePicButton;
    ImageView itemImage;
    String item_name, category_name;
    RelativeLayout rlPproductPic;
   CustomTextView backBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rlPproductPic = findViewById(R.id.rl_product_pic);
        ...
        if (dateFormatDatabase.getCurrentFormat() == 1) {
            expiresOn.setText(m + "/" + d + "/" + year);
        } else {
            expiresOn.setText(d + "/" + m + "/" + year);
        }
        ...
        rlPproductPic.setOnClickListener(view -> {
